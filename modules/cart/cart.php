    ...
    if (isset($_POST["name"]) && isset($_POST["phone"]) && isset($_POST["mail"]) && isset($_POST["add"])) {
        ...
        $str_body .= '
            <tr>
                ...
                <td width="20%"><b>
                        <font color="#FF0000">' . number_format($total_price_all) . ' đ</font>
                    </b></td>
            </tr>
        </table>
        ';
        ...
        try {
            ...
            //Recipients
            $mail->CharSet = 'UTF-8';
            $mail->setFrom('', 'Hung Mobile Shop');                // Gửi mail tới Mail Server
            $mail->addAddress($email);               // Gửi mail tới mail người nhận
            //$mail->addReplyTo('ceo.Hung@gmail.com', 'Information');
            $mail->addCC('');
            ...
            $mail->Subject = 'Xác nhận đơn hàng từ Hung Mobile Shop';
            $mail->Body    = $str_body;
